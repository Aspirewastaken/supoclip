...
import { PlayCircle, Type, Palette, CheckCircle, AlertCircle, Settings, Zap, CreditCard } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your account preferences, usage, and billing
          </p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="billing">
            <div className="max-w-4xl mx-auto">
              <UpgradePrompt
                currentRole={session.user.role || 'free'}
                currentUsage={0}
                quotaLimit={10}
              />
            </div>
